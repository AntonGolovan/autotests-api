...
def assert_get_exercise_response(get_exercise_response: GetExerciseResponseSchema, create_exercise_response: CreateExerciseResponseSchema):
    """
    Проверяет, что ответ на создание задания соответствует ответу на создание задания.

    :param get_exercise_response: Ответ API на на получение данных задания.
    :param create_exercise_response: Ответ API на создания задания.
    :raises AssertionError: Если хотя бы одно поле не совпадает
    """
...
def assert_update_exercise_response(request: UpdateExerciseRequestSchema, response: UpdateExerciseResponseSchema):
    ...
    :param request: Запрос на изменение данных задания.
    :param response: Ответ API на изменение задания.
    :raises AssertionError: Если хотя бы одно поле не совпадает
    """
...
def assert_exercise_not_found_response(actual: InternalErrorResponseSchema):
    """
    Функция проверяет получение ошибки если задание не было найдено на сервере
